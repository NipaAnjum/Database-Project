...
<div class="header">
    ...
    <div style="font-family:Georgia, 'Times New Roman', Times, serif">
        <ul>
        <li><a href="{{ action('AllPageController@index')}}">Home</a></li>
            <li><a href="{{ action('AllPageController@showgallery')}}">Gallery</a></li>
            <li><a href="{{ action('AllPageController@showartist')}}">Artists</a></li>
            <li><a href="{{ action('AllPageController@showexhibition')}}">Exhibitions</a></li>
            </ul>
    </div>
